$(document).ready(function() {
    /*Mis configuraciones*/
    $('span#usuarioName').text(capitalizar(usuario.nombre));
    let img = usuario.img || "storage/user_image/avatar_default.png";
    $('a#cerrarSesion').on('click', function(e) {
        e.preventDefault();
        localStorage.removeItem('Authorization');
        $(location).attr('href', '/login');
    });
    $('img#imgPerfil').attr('src', img);
    /*Fin de mis configuraciones*/
